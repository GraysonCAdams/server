...
FEED_CACHE_EXPIRATION = 24 * 3600
RATE_LIMIT_FALLBACK_BACKOFF = 3600

# Statuses that signal the session cookie was rejected (Overcast redirects to the
# login page); 401/403 are included defensively.
AUTH_REJECT_STATUSES = (301, 302, 303, 307, 308, 401, 403)
